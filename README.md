About flask-allows-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-allows-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/justanr/flask-allows
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2936&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-allows-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-allows` can be installed with `conda`:
...
```
mamba install flask-allows
```

It is possible to list all of the versions of `flask-allows` available on your platform with `conda`:
...
```
mamba search flask-allows --channel conda-forge
```
...
mamba repoquery search flask-allows --channel conda-forge

# List packages depending on `flask-allows`:
mamba repoquery whoneeds flask-allows --channel conda-forge

# List dependencies of `flask-allows`:
mamba repoquery depends flask-allows --channel conda-forge
```
